...
class EasyTransacNotificationModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        try {
            $response = PaymentNotification::getContent(
                $_POST,
        ...
        if (Tools::getIsset('MultiplePayments') && Tools::getIsset('MultiplePaymentsStatus')) {
            $multipay = [
                'ismulti' => Tools::getValue('MultiplePayments'),
                'status' => Tools::getValue('MultiplePaymentsStatus'),
                'repeat' => Tools::getValue('MultiplePaymentsRepeat'),
                'count' => Tools::getValue('MultiplePaymentsCount'),
            ];
        }
